...
name_experiment = 'NRT_BFN_GPGP_test' #'NRT_BFN_main_config' 
...
myGrid = dict(
    ...
    lon_min = -145., #-62.   #-167.                                # domain min longitude

    lon_max = -135., #-52.    #-117.                               # domain max longitude

    lat_min = 25., #6.     #15.                                 # domain min latitude

    lat_max = 35., #17.    #47.                                 # domain max latitude

    dlon = 1/16., #1/8.                                          # zonal grid spatial step (in degree)

    dlat = 1/16., #1/8.                                          # meridional grid spatial step (in degree)
